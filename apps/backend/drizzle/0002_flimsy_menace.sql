...
INSERT INTO `__new_accounts`("commodity_id", "created_at", "currency", "current_cleared_balance_local", "description", "id", "initial_balance", "is_system", "is_tombstone", "name", "type", "updated_at", "user_id") SELECT "commodity_id", "created_at", "currency", "current_cleared_balance_local", "description", "id", "initial_balance", "is_system", "is_tombstone", "name", "type", "updated_at", "user_id" FROM `accounts`;--> statement-breakpoint
